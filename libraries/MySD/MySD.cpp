...
uint8_t walkPath(char *filepath, SdFile& parentDir,
                 uint8_t (*callback)(SdFile& parentDir,
                                     char *filePathComponent,
                                     uint8_t isLastComponent,
                                     void *object),
                 void *object = NULL) {
    /*
...
uint8_t callback_pathExists(SdFile& parentDir, char *filePathComponent,
    ...
    uint8_t exists = child.open(&parentDir, filePathComponent, O_RDONLY);
...
uint8_t callback_makeDirPath(SdFile& parentDir, char *filePathComponent,
                             uint8_t isLastComponent, void *object) {
    /*
...
uint8_t callback_remove(SdFile& parentDir, char *filePathComponent,
                        uint8_t isLastComponent, void *object) {
    if (isLastComponent) {
...
uint8_t callback_rmdir(SdFile& parentDir, char *filePathComponent,
                       uint8_t isLastComponent, void *object) {
    if (isLastComponent) {
        SdFile f;
...
uint8_t SDClass::exists(char *filepath) {
    /*
...
uint8_t SDClass::mkdir(char *filepath) {
    /*
...
uint8_t SDClass::rmdir(char *filepath) {
    /*
...
uint8_t SDClass::remove(char *filepath) {
    return walkPath(filepath, root, callback_remove);
}

void SDClass::enableCRC(uint8_t mode) {
    card.enableCRC(mode);
}
